 ...
 * @notice Manages USDm (cUSD) -powered tournaments for the Celo Flash arcade game.
...
contract CeloFlashTournament is ReentrancyGuard, Ownable, Pausable {
    ...
    /// @notice Maximum entry fee ($100 cUSD — 18 decimals)
    ...
    /// @notice The stablecoin used for entry fees and prizes (cUSD on Celo)
    ...
    /**
     * @param _stablecoin  Address of the stablecoin token (cUSD)
